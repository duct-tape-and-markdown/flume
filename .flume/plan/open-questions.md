...
## The dogfood chain's header still teaches the pre-0.10 module shape (observation, from PRE-0.10-CHAIN-SHAPE-TAUGHT)
...
## Spec and docs still say the observational chain load fails silently (observation, from CHAIN-LOAD-FAILURE-REPORTED)
