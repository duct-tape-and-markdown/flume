...
Covered this rotation: src/builtinGates.ts, src/Dispatcher.ts, src/Prompt.ts, tests/PendingSchema.test.ts, tests/Dispatcher.test.ts
...
Plan continues: yes — posture sweep rotation open (one neighborhood/tick; more of the domain touched since the stamp remains unswept)
