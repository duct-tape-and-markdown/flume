...
/**
 * The state root as the repository addresses it, or a refusal naming both
 * roots.
 */
...
/**
 * A path the engine composed in the host's dialect, as the forward-slash
 * form a fence glob and a commit's touched path are both in.
 */
